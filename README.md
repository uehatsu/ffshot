...
起動するとトレイにキツネのアイコンが出ます。左クリックまたは右クリックでメニューが開き、ダブルクリックで設定画面が開きます。メニューには「全画面を撮影」「アクティブウィンドウを撮影」「設定...」「保存先を開く」「終了」があります（通常権限のときは「管理者として再起動」も表示）。

<img src="docs/doc_01.png" width="415" alt="トレイのキツネアイコンとメニュー">
